...
const STEPS: Step[] = [
  {
    ...
    desc: "Yes, a real human who can translate industry jargon into plain English for you.",
  },
  {
    img: "/images/how_it_works_2.png",
    step: "02",
    title: "Get a quote",
    desc: "We work with more than 50 insurance carriers to ensure you get the best coverage at the best price.",
  },
  {
