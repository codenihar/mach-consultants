...
const HeroSection: React.FC = () => {
  return (
    <section className="w-full flex items-center bg-gradient-to-r from-blue-100 to-yellow-100 px-4 sm:px-6 md:px-8 lg:px-16 pt-24 pb-48 md:pt-36 font-PTSerif">
