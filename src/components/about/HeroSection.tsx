    ...
    <section className="max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 md:py-20 lg:py-28 xl:py-36 pt-30 md:pt-28 font-RecoletaRegular">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 items-start mt-2 sm:mt-3 md:mt-4">
        ...
        <div className="space-y-3 sm:space-y-4 md:space-y-6">
          <h2 className="hidden md:block text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[10rem] leading-none font-bold font-RecoletaRegular text-black tracking-tight">
            US
          </h2>
