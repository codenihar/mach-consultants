...
const AboutHeroSection: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 md:py-20 lg:py-28 xl:py-36 pt-30 md:pt-28 font-RecoletaRegular">
      {/* Title Section */}
      <h2 className="max-sm:flex max-sm:gap-2 text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[10rem] leading-none font-bold text-black tracking-tight font-RecoletaRegular">
        ABOUT{" "}
